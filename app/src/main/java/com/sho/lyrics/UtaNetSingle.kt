...
//    }
    ...
    fun scrapeLyrics(songLink:String): String {
//        number = songLink.drop(1).dropLast(1).split('/')[1]
        val graphicSpace = "\u3000"

//        val songLink = "${searchEngine}${songLink}"  //
        ...
        val lyricsInfo = arrayOf( title, "${lyrics}${temp}", singers, lyricists, composers, releaseDate, number, studio )
